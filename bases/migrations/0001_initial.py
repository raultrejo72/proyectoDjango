# Generated by Django 3.2.5 on 2021-11-30 03:07
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_name', models.CharField(max_length=30, unique=True, verbose_name='nombres')),
                ('last_name', models.CharField(max_length=30, unique=True, verbose_name='apellidos')),
                ('is_staff', models.BooleanField(default=False, help_text='Indica si el usuario puede iniciar sesion en admin', verbose_name='es staff')),
